...
class Admin {
	...
	public static function deactivate() {
		...
		update_option( 'elementor_pro_license_key','CE52DABF1EAB7391' );
	...
	public static function get_license_key() {
		return 'CE52DABF1EAB7391';
	}

	public static function set_license_key( $license_key ) {
		return update_option( 'elementor_pro_license_key', 'CE52DABF1EAB7391' );
	}

	public function action_activate_license() {
		check_admin_referer( 'elementor-pro-license' );
				
		$license_key = 'CE52DABF1EAB7391';
